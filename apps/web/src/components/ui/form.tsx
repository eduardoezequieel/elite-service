...
/**
 * Etiqueta del campo: usa el `Label` del proyecto (Label de 12px, peso 600, caja
 * normal, en Grafito). Con error pasa a `--destructive`.
 */
...
/** Ayuda del campo: Cuerpo denso (13px) en Grafito. */
...
/** Mensaje de error: Cuerpo denso (13px) en Sello Rojo. El texto viene del API. */
