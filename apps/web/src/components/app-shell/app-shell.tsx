 ...
 * global: el riel ya dice dónde estás. Bajo 768px el riel se muda al pie como
 * barra de iconos y el contenido ocupa todo el ancho.
 *
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <main className="mx-auto w-full max-w-[1440px] flex-1 p-plate">{children}</main>
        <NavBottomBar />
      </div>
    </div>
  );
